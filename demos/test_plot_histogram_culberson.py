...
#df=pd.read_csv(os.getenv('HOME')+'/chenyk.data2/various/cyksmall/texnet/realtime/culberson20221128_20221231.csv')
...
plt.savefig('culberson_fig.png',format='png',dpi=300,bbox_inches='tight', pad_inches=0)
plt.show()
