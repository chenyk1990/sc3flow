...
time1='2022-10-28 00:00:00'
# time2='2022-12-31 23:59:59'
time2='2023-04-28 23:59:59'

timestr=time1.split()[0].replace("-","")+"_"+time2.split()[0].replace("-","")
# timestr="20221128_20221231"
...
query=query.replace('2022-11-28 00:00:00',time1) #very tricky here
query=query.replace('2022-12-31 23:59:59',time2) #very tricky here

print(query)
df = pd.read_sql(query, mydb)
df.to_csv('culberson_%s.csv'%timestr)
...
plt.savefig('culberson_fig_%s.png'%timestr,format='png',dpi=300,bbox_inches='tight', pad_inches=0)
plt.show()
